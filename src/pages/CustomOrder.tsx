    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-32 text-center">
        ...
        >
          ...
          <h2 className="text-4xl font-serif font-bold text-brand-olive mb-4">Request Received!</h2>
          <p className="text-brand-olive/60 mb-8 leading-relaxed">
            Thank you for your interest in a custom piece. I'll review your request and get back to you within 2-3 business days to discuss the details and pricing.
          </p>
          <button 
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input type="tel" className="w-full px-6 py-4 bg-brand-cream/50 border border-brand-olive/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand-clay/20" />
            </div>

            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest font-bold text-brand-olive/40 ml-1">Description of Gift</label>
              <textarea required rows={4} className="w-full px-6 py-4 bg-brand-cream/50 border border-brand-olive/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand-clay/20 resize-none" placeholder="Describe what you have in mind..."></textarea>
            </div>

            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest font-bold text-brand-olive/40 ml-1">Reference Image</label>
              <div className="border-2 border-dashed border-brand-olive/10 rounded-2xl p-8 text-center hover:bg-brand-olive/5 transition-colors cursor-pointer group">
